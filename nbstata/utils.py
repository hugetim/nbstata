...
# %% auto 0
__all__ = ['parse_code_if_in_regex', 'comment_regex', 'delimit_regex', 'multi_regex', 'parse_browse_magic', 'in_range',
...
def parse_browse_magic(code):
    """For use in `nbstata.magics.StataMagics.magic_browse`"""
