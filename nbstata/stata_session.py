...
# %% ../nbs/08_stata_session.ipynb #4b35edd5
...
# %% ../nbs/08_stata_session.ipynb #d3be7f0a
class StataSession():
    def __init__(self):
        """"""
...
# %% ../nbs/08_stata_session.ipynb #32d58f0d
@patch_to(StataSession)
def refresh_suggestions(self):
    self.suggestions = self.get_suggestions()

# %% ../nbs/08_stata_session.ipynb #0ce69eb3
@patch_to(StataSession)
...
# %% ../nbs/08_stata_session.ipynb #0ff67313
@patch_to(StataSession)
def get_local_dict(self):
    return _get_local_dict(self._get_locals())

# %% ../nbs/08_stata_session.ipynb #442b1ea4
@patch_to(StataSession)
...
# %% ../nbs/08_stata_session.ipynb #680deaa8
...
# %% ../nbs/08_stata_session.ipynb #b1683f82
...
# %% ../nbs/08_stata_session.ipynb #d5e4965b
@patch_to(StataSession)    
...
# %% ../nbs/08_stata_session.ipynb #b66518fa
...
# %% ../nbs/08_stata_session.ipynb #9188f72c
@patch_to(StataSession)
...
# %% ../nbs/08_stata_session.ipynb #3d484709
@patch_to(StataSession)
