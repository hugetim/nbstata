...
# %% auto 0
__all__ = ['comment_regex', 'stata_lexer', 'delimit_regex', 'multi_regex', 'remove_comments', 'ending_sc_delimiter',
           'standardize_code', 'is_start_of_program_block', 'break_out_prog_blocks']
