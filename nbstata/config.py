...
# %% ../nbs/01_config.ipynb #0f124fe2-229e-424c-8001-1635ee96f095
...
# %% ../nbs/01_config.ipynb #aa9269cb-3ead-42f9-8c92-b3b18a779d5a
...
# %% ../nbs/01_config.ipynb #b5d488d9-f728-4804-98f6-b2c13ff205c3
...
# %% ../nbs/01_config.ipynb #e6fb6a87-e043-4bc7-9717-44464449555e
...
# %% ../nbs/01_config.ipynb #a9230eae-f81c-430d-bfcd-7e2ff7e4d384
def find_edition(stata_dir):
    stata_path = _find_path(stata_dir)
    stata_exe = str(os.path.basename(stata_path)).lower()
    return _edition(stata_exe)

# %% ../nbs/01_config.ipynb #47010d9c
...
# %% ../nbs/01_config.ipynb #cc3a55fd
def _set_graph_size(width, height):
    import pystata
    pystata.config.set_graph_size(width, height)

# %% ../nbs/01_config.ipynb #67e2188a-df44-4d62-a7ae-ec57419cdc17
