...
# %% ../nbs/14_kernel.ipynb #cad5222a
@patch_to(PyStataKernel)
def post_do_hook(self):
    self.inspect_output = ""

# %% ../nbs/14_kernel.ipynb #f4481d93
@patch_to(PyStataKernel)
...
# %% ../nbs/14_kernel.ipynb #aa148fb8
@patch_to(PyStataKernel)
def do_is_complete(self, code):
    """Overrides IPythonKernel with kernelbase default"""
    return {"status": "unknown"}

# %% ../nbs/14_kernel.ipynb #cfa3e96c
@patch_to(PyStataKernel)
def do_history(
    self,
    hist_access_type,
