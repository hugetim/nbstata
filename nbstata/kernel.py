# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_kernel.ipynb.

# %% auto 0
__all__ = ['PyStataKernel', 'Cell', 'print_stata_error']

# %% ../nbs/05_kernel.ipynb 4
...
def init_stata(self):
    ...
    self.completions = CompletionsManager()
    self.stata_ready = True

# %% ../nbs/05_kernel.ipynb 8
class Cell:
