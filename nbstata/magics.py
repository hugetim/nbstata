# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/06_magics.ipynb.

# %% auto 0
__all__ = ['print_kernel', 'StataMagics']

# %% ../nbs/06_magics.ipynb 3
from .helpers import *
from .utils import *
