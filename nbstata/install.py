...
# %% ../nbs/15_install.ipynb #7571a012-6b15-4d01-91c1-0ebcbc1e1fa9
def _find_stata():
...
# %% ../nbs/15_install.ipynb #cbe6dbc7-9399-48d6-b36d-3ea2228d57a8
...
# %% ../nbs/15_install.ipynb #bd472989-154c-4081-b0ed-8319f563d714
...
# %% ../nbs/15_install.ipynb #87bcb3d3-dc1d-4f45-9a7f-94d807fb6310
def _is_root():
    try:
        return os.geteuid() == 0
...
# %% ../nbs/15_install.ipynb #e1a689d6-85c1-42ce-9524-425cbc9570c4
...
# %% ../nbs/15_install.ipynb #2ab1d1be-a9c8-4454-9a6c-7d0c0f695371
def main(argv=None):
...
# %% ../nbs/15_install.ipynb #a1cc02dd-3e38-4324-866e-f19a130e38fd
#| eval: false
