# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_completions.ipynb.

# %% auto 0
__all__ = ['CompletionsManager', 'variable_names', 'diverted_stata_output']

# %% ../nbs/04_completions.ipynb 4
...
def diverted_stata_output(code):
    ...
    tf.close()
    pystata.config.set_output_file(tf.name, replace=True)
    run_noecho(code)
...
#             pos += posextra
    ...
    closing_symbol = False #config.get('autocomplete_closing_symbol', 'False')
