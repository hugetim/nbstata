...
# %% auto 0
__all__ = ['get_local', 'set_local', 'get_global', 'set_global', 'get_scalar', 'stata_formatted', 'variable_names', 'drop_var',
           'obs_count', 'pwd', 'macro_expand', 'run_direct', 'run_single']
